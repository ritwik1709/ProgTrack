        ...
        <>
            <Popover className={`relative`}>
                ...
                <Popover.Panel className="absolute z-10 left-0">
                    <div className="w-48 bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 shadow select-none p-1 divide-y">
                        <div className='py-[3px]'>
                            <button onClick={() => setModalState(true)} className='transition-colors duration-75 flex w-full items-center rounded-md px-2.5 py-2 text-sm space-x-2.5 text-slate-500 dark:text-gray-200 hover:bg-indigo-500 hover:text-gray-100'>
                        ...
                        <div className='py-[3px]'>
                            <button onClick={handleDelete} className='transition-colors duration-75 flex w-full items-center rounded-md px-2.5 py-2 text-sm space-x-2 text-slate-500 dark:text-gray-200 hover:bg-red-500 hover:text-gray-100'>
